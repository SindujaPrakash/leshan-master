...
public class LeshanClientDemo {
    ...
    private static final int OBJECT_ID_TEMPERATURE_SENSOR = 3347;
    private final static String DEFAULT_ENDPOINT = "HackatonSampleDevice";
    ...
    public static void main(final String[] args) {
        ...
        serverURI = "coap://active-things.esl.eng.it:" + LwM2m.DEFAULT_COAP_PORT;
